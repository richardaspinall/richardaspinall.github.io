...
repos_to_add=('cinema-room-rest-service' 'get-github-repos' 'vue-todolist' 'tinyurl-generator' 'remote-file-unfurler' 'timezone-converter' 'slack-api-feature-breakdowns' 'ping-pong')
